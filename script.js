const questions = {
  ...
  page3: [
    {
      ...
      category: "Law",
      question:
        "الخطر الذي تشكله المركبات المتوقفة إلى جانب الرصيف الأيمن على السائق المار بقربها هو:",
      answers: [
        "احتمال انطلاق أحدها ودخولها السير فجأة",
        "صدور صوت جهاز إنذار السرقة",
        "صدور رائحة عوادم",
      ],
      correctAnswer: "احتمال انطلاق أحدها ودخولها السير فجأة",
    },
    {
      id: 25,
      category: "Law",
      question: "كسائق إحترازي عليك أن:",
      answers: [
        "لا تنتظر أن تُفسح لك الطريق",
        "تفسح المرور قدر الإمكان لمن حولك",
        "تنتظر أن تُفسح لك الطريق دائماً",
      ],
      correctAnswer: "تفسح المرور قدر الإمكان لمن حولك",
    },
    {
      id: 26,
      category: "Law",
      question: "أثناء القيادة وقبل استعمالك الفرامل، عليك أولاً أن تنظر:",
      answers: [
    ...
    },
    {
      ...
      answers: [
        "من الطبيعي أن يسبب ارتجاجاً في دواسة الفرامل",
        "من الطبيعي أن يصدر ضوضاء وأن يسبب ارتجاجاً في دواسة الفرامل",
        "ليس من الطبيعي أن يصدر ضوضاء أو يسبب ارتجاجاً في دواسة الفرامل",
      ],
      correctAnswer:
        "من الطبيعي أن يصدر ضوضاء وأن يسبب ارتجاجاً في دواسة الفرامل",
    },
    {
      ...
      answers: [
        ...
        "يمنع انغلاق الفرامل، ولا يمكن السائق من توجيه المركبة",
    ...
    },
    {
      id: 29,
      category: "Law",
      question: "عند تعرض مركبتك للانزلاق، عليك، وبسرعة أن:",
      answers: [
        "تضغط على الفرامل وتوجه مركبتك بعكس اتجاه الانزلاق",
        "ترفع قدمك عن دواسة البنزين ولا تضغط على الفرامل، ووجّه المركبة إلى الجهة التي تنزلق إليها",
        "تزيد السرعة",
      ],
      correctAnswer:
        "ترفع قدمك عن دواسة البنزين ولا تضغط على الفرامل، ووجّه المركبة إلى الجهة التي تنزلق إليها",
    },
    {
      ...
      answers: [
        "تفادي الاصطدام بها في حال توقفت فجأة",
        "التمتع بالمناظر الخلابة حولك",
        "توفير وقود المركبة",
      ],
      correctAnswer: "تفادي الاصطدام بها في حال توقفت فجأة",
    },
    {
      id: 31,
      category: "Safety",
      question:
        "لحظة انطلاق المركبة التي أمامك مباشرة عند ضوء الإشارة الضوئية من اللون الأحمر إلى اللون الأخضر، يجب عليك أن:",
      answers: [
    ...
    },
    {
      ...
      category: "Safety",
      question:
        "عندما تقترب بمركبتك من إشارة مرور ضوئية صفراء واحدة تومض، يجب عليك أن:",
      answers: ["تربط حزام الأمان", "تخفف السرعة", "تتوقف"],
      correctAnswer: "تخفف السرعة",
    },
    {
      id: 33,
      category: "Safety",
  ...
  page4: [
    ...
    },
    {
      ...
      answers: ["بيد واحدة", "بكثرة اليدين", "بأصابع اليدين"],
      correctAnswer: "بكثرة اليدين",
    },
    {
      id: 36,
      category: "Safety",
    ...
    },
    {
      ...
      answers: [
        ...
        "المقطورة تلامس الأرض على رجل واحدة",
        "لاحظ الهواء والأسلاك الكهربائية موصولة بشكل جيد",
      ],
      correctAnswer: "لاحظ الهواء والأسلاك الكهربائية موصولة بشكل جيد",
    },
    {
      id: 38,
      category: "Law",
      question: "بعد ربط القاطرة بالمقطورة على السائق أن ينتهي إلى أن:",
      answers: [
        "المقطورة تلامس الأرض على رجل واحدة",
        "خطوط الهواء فقط موصولة بشكل جيد",
        "الأسلاف الكهربائية فقط موصولة بشكل جيد",
      ],
      correctAnswer: "المقطورة تلامس الأرض على رجل واحدة",
    },
    {
      id: 39,
      category: "Law",
    ...
    },
    {
      ...
      answers: [
        "يرجع القاطرة بطء فوق المقطورة",
        "يرجع القاطرة بسرعة تحت المقطورة",
        "يرجع القاطرة بطء تحت المقطورة",
      ],
      correctAnswer: "يرجع القاطرة بطء تحت المقطورة",
    },
    {
      id: 41,
      category: "Law",
      question: "عند فصل القاطرة عن المقطورة، على السائق أن يختار مكاناً:",
      answers: ["منحدراً وليئاً.", "مستحاً وليئاً.", "منحدراً وصليماً."],
      correctAnswer: "مستحاً وليئاً.",
    },
    {
      id: 42,
      category: "Law",
      ...
      answers: [
        "يشدد مراحل القطرة ولا ينزل أرجلها إلى القصى حد",
        "يشدد مراحل القطرة وينزل أرجلها إلى القصى حد",
        "لا يشدد مراحل القطرة وينزل أرجلها إلى القصى حد",
      ],
      correctAnswer: "يشدد مراحل القطرة وينزل أرجلها إلى القصى حد",
    },
    {
      id: 43,
      category: "Law",
    ...
    },
    {
      id: 44,
      category: "Law",
      question: "سائق المركبة الثقيلة بقع عمياء حول مركبته وعددها:",
      answers: [
        "أربع بقعة عمياء على الأقل",
        "ثماني بقعة عمياء على الأقل",
        "ثلاث بقعة عمياء",
      ],
      correctAnswer: "أربع بقعة عمياء على الأقل",
    },
    {
      id: 45,
      category: "Law",
    ...
    },
    {
      ...
      answers: [
        "يرجع إلى الخلف في الأماكن المكثفة",
